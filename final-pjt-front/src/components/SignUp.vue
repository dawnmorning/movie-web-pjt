  ...
  <nav class="navWrap">
    <div class="contentsWrap" style="font-size: 20px; margin-top: 0">
      <form
        ...
        class="formWrap animate__animated animate__fadeIn"
      >
        <!-- <div class="jua"></div> -->
        <div
          class="jua animate__animated animate__fadeInUp aniamte_duration-2s"
          style="
            position: relative;
            left: 30px;
            margin-left: 30px;
        ...
        >
          <img
            ...
            src="http://127.0.0.1:8000/media/final_logo.jpg"
            alt="우리 로고"
          />
        </div>
        ...
        <div class="signupWindow jua" style="height: 500px">
          ...
          <div class="inlineToBlock">
            <input
              ...
              class="id"
            />
            <p class="ErrorMsg" v-if="ErrorMessage?.username">
          ...
          <div class="inlineToBlock">
            <input
              ...
              class="nick"
            />
            <p class="ErrorMsg" v-if="ErrorMessage?.nickname">
          ...
          <div class="inlineToBlock">
            <input
              ...
              class="email"
            />
            <p class="ErrorMsg" v-if="ErrorMessage?.email">
          ...
          <div class="inlineToBlock">
            <input
              ...
              class="pw"
            />
            <p class="ErrorMsg" v-if="ErrorMessage?.password1">
              {{ ErrorMessage.password1[0] }}
            </p>
          </div>
          <div class="inlineToBlock">
            <input
            ...
            <div>
              <p
                class="ErrorMsg"
                v-if="ErrorMessage?.password2"
                style="margin-bottom: 0px"
              >
                {{ ErrorMessage.password2[0] }}
              </p>
              <p class="ErrorMsg" v-if="dismatchPW">
                비밀번호가 동일하지 않습니다.
              </p>
            </div>
          </div>
          <button
            class="inlineToBlock ordinaryLgin unactivatedLoginColor btn btn-primary"
            type="submit"
            style="margin-top: 0"
          >
            회원가입
...
export default {
  ...
  computed: {
    ErrorMessage() {
      return this.$route.query.response?.data;
    },
    dismatchPW() {
      let message = null;
